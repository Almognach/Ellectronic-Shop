...
namespace Electro_Shop.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StreetName,CityName,PhoneNumber,Email")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StreetName,CityName,PhoneNumber,Email")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
